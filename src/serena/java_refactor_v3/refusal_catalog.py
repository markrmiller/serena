...
# -- live Java sidecar refusal codes (kept in parity by tests) -------------------------------
register_refusal_code('ambiguous_member', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('build_file_rewrite_unsupported', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_class_abstract_method', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_class_constructor_unanalyzable', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_class_external_usage', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_class_native_method', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_class_public_api_field', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_class_public_api_without_delegates', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_class_source_type_parameter', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_class_static_field', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_class_static_method', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_class_synchronized_receiver', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_class_target_file_exists', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_class_target_is_source', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_class_target_type_exists', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_class_unanalyzable_method', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_class_unselected_field_dependency', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_class_retained_field_dependency', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_class_unselected_method_dependency', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_class_uses_super', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_superclass_abstract_member', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_superclass_constructor_unanalyzable', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_superclass_constructor_with_existing_super', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_superclass_existing_superclass', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_superclass_member_not_common', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_superclass_member_not_equivalent', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_superclass_member_ambiguous', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_superclass_private_member', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_superclass_target_file_exists', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_superclass_target_is_source', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('extract_superclass_target_type_exists', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('insufficient_classes', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('invalid_member', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('io_error', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('malformed_move_package', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('malformed_move_source_root', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('malformed_recipe', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('malformed_rename_package', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('missing_field', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('move_package_failed', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('no_sources', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('non_editable_target', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('package_split_across_modules', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('recipe_apply_failed', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('recipe_scan_failed', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('recipe_unresolved_symbol', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('recipe_unsupported_template', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('rename_package_failed', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('replace_inheritance_base_constructor_args', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('replace_inheritance_constructor_unanalyzable', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('replace_inheritance_generic_subclass', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('replace_inheritance_generic_superclass', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('replace_inheritance_generic_method', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('replace_inheritance_override_calls_super', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('replace_inheritance_sealed_superclass', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('replace_inheritance_superclass_mismatch', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('resource_rename_empty', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('malformed_resource_edit_map', "Resource edit maps must have non-empty string keys and values.")
register_refusal_code('source_type_not_found', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('unparseable_source', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('unsupported_resource_kind', "Live Java sidecar refusal code emitted by the V3 planner.")
register_refusal_code('unsupported_source_kind', "Live Java sidecar refusal code emitted by the V3 planner.")
